...
export const Contact = () => {
    return (
        <Section>
            ...
            <p>I'm currently open for work so, if you're interested, shoot me an email at <b className="contact__email">lewis@lewishamer.co.uk</b> and we can get talking. You can also reach out to me on other platforms too!</p>

            <span className="contact__buttons">
                <Button onclick={() => window.open('mailto:lewis@lewishamer.co.uk','_blank')}>Email</Button>
